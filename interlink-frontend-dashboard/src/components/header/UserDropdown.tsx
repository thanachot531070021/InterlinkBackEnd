...
export default function UserDropdown() {
  ...
  const [userInfo, setUserInfo] = useState({ username: 'User', email: 'user@example.com', role: 'Guest' });
  ...
  // Prevent hydration mismatch by not rendering user info until mounted
  if (!mounted) {
    return (
